      ...
      <div className="product-listing-card">
         {bookData && (
          ...
          <div className="product-listing-img-container">
            ...
            <img src={bookData.book_img} alt="product-listing" className="product-listing-image " />
          </div>
          ...
          <div className="card-btn-container">
              <Link to={`/book-details/${bookData.id}`} className="product-listing-button">Buy Now</Link>
          </div>
          </>
      )}
      </div>
